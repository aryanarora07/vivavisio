    ...
    <section className='max-w-7xl mx-auto '>
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[700px]">
          Create imaginative and visually stunning images through VivaVisio AI and 
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          ...
          <FormField
            ...
            type = "text"
            name = "prompt"
            placeholder = "A red ferrari flying towards the sun"
            value = {form.prompt}
            handleChange = {handleChange}
            isSurpriseMe
          ...
          h-64 flex justify-center items-center">
            {form.photo ?
            (
              <img src={form.photo} alt={prompt.name} className='w-full h-full object-contain'/>
            ): (
        ...
        <div className="mt-10">
          <p className='mt-2 text-[#666E75] text-[14px]'>Once you have created an image if you want,
